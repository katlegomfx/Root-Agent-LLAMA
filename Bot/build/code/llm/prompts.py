...
async def embedText(writtenText, model='nomic-embed-text'):
    ...
    try:
        ...
        async for part in response_generator:
            ...
            embedded_response += section
        print()
        return embedded_response
    
        # request_response = ollama.embed(model='llama3.2',
                    #  input='The sky is blue because of rayleigh scattering')
        # ollama.embed(model='llama3.2', input=[
        #              'The sky is blue because of rayleigh scattering', 'Grass is green because of chlorophyll'])
